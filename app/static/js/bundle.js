    ...
    1: [
      function (require, module, exports) {
        ...
        document.addEventListener("DOMContentLoaded", function () {
          ...
          const priceInWords = document.getElementById("price-in-words");
        ...
        document.addEventListener("DOMContentLoaded", function () {
          const changePaidButton =
            document.getElementById("change-paid-button");
        ...
        module.exports = {
          ...
          units: [
            ...
            },
            {
              ...
              useFewEnding: true,
              avoidEndingRules: [
                11, 12, 13, 14, 111, 112, 113, 114, 211, 212, 213, 214, 311,
                312, 313, 314, 411, 412, 413, 414, 511, 512, 513, 514, 611, 612,
                613, 614, 711, 712, 713, 714, 811, 812, 813, 814, 911, 912, 913,
                914,
              ],
            },
            {
    ...
    18: [
      function (require, module, exports) {
        ...
        function writtenNumber(n, options) {
          ...
          var firstSignificantN =
            firstSignificant * Math.floor(n / firstSignificant);
